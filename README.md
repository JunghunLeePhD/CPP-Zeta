...
```bash
ffmpeg -framerate 30 -i output/frames_hardy/frame_%04d.ppm -c:v libx264 -pix_fmt yuv420p output/hardy_scan.mp4
```

**Complex Plane Trajectory:**

```bash
ffmpeg -framerate 30 -i output/frames_trajectory/frame_%04d.ppm -c:v libx264 -pix_fmt yuv420p output/zeta_trajectory.mp4
```
